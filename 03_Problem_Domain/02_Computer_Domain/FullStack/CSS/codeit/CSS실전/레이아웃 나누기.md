...
<ul class="items">
	<li class="item">
		...
		<div class="item-color-chip" style="backround: #EFB578"></div>
...
```
> 여기서 중요한 포인트가 화살표 몸통부분(---)은 높이가 0인 div를 만들고 점선 테두리(border: 2px dashed ...) 로 만들었고 화살표 머리 부분은 미리 주어진 arrow.svg이미지를 겹치게